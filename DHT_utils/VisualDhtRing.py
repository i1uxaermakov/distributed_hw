...
def parseCmdLineArgs ():
  ...
  parser = argparse.ArgumentParser (description="Visualize DHT Ring Application")
...
#   parser.add_argument ("-d", "--data", type=list, default=["weather", "humidity", "airquality","light", "pressure", "temperature", "sound", "altitude", "location", "sub1", "sub2", "sub3", "sub4", "sub5", "pub1:10.0.0.10:7777", "pub2:10.0.0.13:7777", "pub3:10.0.0.2:7777", "pub4:10.0.0.10:7776", "pub5:10.0.0.2:7776"])
    ...
    # dht_15.json
  parser.add_argument ("-d", "--data", type=list, default=["weather", "humidity", "airquality","light", "pressure", "temperature", "sound", "altitude", "location", "sub1", "sub2", "sub3", "sub4", "sub5", "pub1:10.0.0.2:7777", "pub2:10.0.0.14:7777", "pub3:10.0.0.14:7776", "pub4:10.0.0.11:7777", "pub5:10.0.0.10:7777"])
